...
class SchwarzschildEccentricWaveformBase(
    ...
    def __init__(
        ...
        # setup amplitude normalization, if it is required
        ...
        **kwargs,
        ...
        for i, inds_in in iterator:
            ...
            # get a specific subset of modes
                ...
                #         xp.abs(
                #             xp.concatenate(
                #                 [teuk_modes_in, xp.conj(teuk_modes_in[:, self.m0mask[keep_modes]])],
                #                 axis=1,
                #             )
                #         )
                #         ** 2,
                ...
                #     # normalize
                #     factor = amp_norm[inds_in] / amp_for_norm
                #     teuk_modes_in = teuk_modes_in * factor[:, np.newaxis]
