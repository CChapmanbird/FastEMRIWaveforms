...
class EMRIInspiral(TrajectoryBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        nparams = 6
        self.inspiral_generator = get_integrator(func, nparams, few_dir, rootfind_separatrix=rootfind_separatrix, orbital_resonances=orbital_resonances, which_resonances=which_resonances)
